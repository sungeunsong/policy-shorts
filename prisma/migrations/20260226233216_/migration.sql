...
CREATE TABLE "TopicKeyword" (
    ...
    CONSTRAINT "TopicKeyword_presetId_fkey" FOREIGN KEY ("presetId") REFERENCES "TopicPreset" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "AppSetting" (
    ...
    "activePresetId" TEXT,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "AppSetting_activePresetId_fkey" FOREIGN KEY ("activePresetId") REFERENCES "TopicPreset" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "Run" (
    ...
    "summaryJson" TEXT,
    CONSTRAINT "Run_presetId_fkey" FOREIGN KEY ("presetId") REFERENCES "TopicPreset" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "Judgment" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "Judgment_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "Item" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "Candidate" (
    ...
    "rank" INTEGER,
    CONSTRAINT "Candidate_runId_fkey" FOREIGN KEY ("runId") REFERENCES "Run" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "Candidate_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "Item" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
